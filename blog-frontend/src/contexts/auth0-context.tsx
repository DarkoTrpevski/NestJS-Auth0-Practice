...
export class Auth0Provider extends Component<{}, IState> {
	...
	render() {
		...
		console.log('Inside Auth0Provider, auth0Client is: ', this.state.auth0Client);
		console.log('Inside Auth0Provider, auth0Client loginWithRedirect is: ', this.state.auth0Client.loginWithRedirect);
